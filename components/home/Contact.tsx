export default () => {
    ...
    return (
        <main style={{ background: "#efeded" }} className="relative py-28 ">
            <div className="relative z-10 max-w-screen-xl mx-auto text-gray-600 sm:px-4 md:px-8">
                ...
                <div className="mt-12 mx-auto px-4 p-8 bg-white sm:max-w-lg sm:px-8 sm:rounded-xl">
                    ...
                    >
                        ...
                        <button
                            className="w-full px-4 py-2 text-white font-medium bg-primary hover:bg-gray-700 active:bg-gray-900 rounded-lg duration-150"
                        >
                            Submit
                        </button>
                    </form>
