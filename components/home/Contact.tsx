                ...
                <div className="max-w-lg mx-auto gap-12 justify-between lg:flex lg:max-w-none">
                    ...
                    <div className="flex-1 mt-12 sm:max-w-lg lg:max-w-md">
                        ...
                        >
                            ...
                            <button
                                className="w-full px-4 py-2 font-medium text-white bg-primary hover:bg-secondary active:bg-indigo-600 rounded-lg duration-150"
                            >
                                Submit
                            </button>
                        </form>
