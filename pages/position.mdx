...
<details className="border border-gray-300 rounded-lg mt-4 p-4">
  <summary>
    <span className="font-bold text-[#243751]">Postdoctoral</span>
    <span className="ml-3 inline-block bg-green-100 text-green-700 text-xs font-bold px-2 py-1 rounded-full">
      HIRING
    </span>
  </summary>
...
<details className="border border-gray-300 rounded-lg mt-4 p-4">
  <summary>
    <span className="font-bold text-[#243751]">Full time Graduate Students</span>
    <span className="ml-3 inline-block bg-green-100 text-green-700 text-xs font-bold px-2 py-1 rounded-full">
      MSc HIRING
    </span>
    <span className="ml-2 inline-block bg-gray-200 text-gray-600 text-xs font-bold px-2 py-1 rounded-full">
      PhD FILLED
    </span>
  </summary>

## Full time Graduate Students: Fall 2027 Intake 

<div className="border-l-4 border-[#243751] bg-gray-100 p-4 my-4 rounded-r-lg">
  <div className="font-bold text-[#243751] text-lg mb-2">
    Fall 2027 Intake Update
  </div>

  <div className="mb-1">
    <span className="font-bold text-green-700">OPEN</span>
    {" "}Full time MSc positions
  </div>

  <div>
    <span className="font-bold text-red-700">FILLED</span>
    {" "}Full time PhD position. We are no longer accepting full time PhD applications for Fall 2027.
  </div>
</div>

**HIVE Lab is currently accepting applications for full time MSc students for Fall 2027.**
...
1. A current **CV**
2. **Sample publications, manuscripts, or writing samples**
3. The **name and email address of two references**
4. A **one-page research statement** describing:
   - Previous research experience
   - Relevant expertise in AI/LLMs, NLP, and causal methods
...
<details className="border border-gray-300 rounded-lg mt-4 p-4">
  <summary>
    <span className="font-bold text-[#243751]">Flex PhD and Part Time MSc Students</span>
    <span className="ml-3 inline-block bg-green-100 text-green-700 text-xs font-bold px-2 py-1 rounded-full">
      HIRING
    </span>
  </summary>
...
<details className="border border-gray-300 rounded-lg mt-4 p-4">
  <summary>
    <span className="font-bold text-[#243751]">Volunteers and Practicum Students</span>
    <span className="ml-3 inline-block bg-green-100 text-green-700 text-xs font-bold px-2 py-1 rounded-full">
      OPEN
    </span>
  </summary>
